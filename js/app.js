...
(() => {
  ...
  (() => {
    ...
    console.log("123"), console.log("12345"), c();
    function u(e, t) {
    ...
    const I = {
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (n = E(e), r = 0; r < n.length; r += 1) if (n[r] === i) return !0;
          return !1;
        }
        if (e === s) return i === s;
        if (e === t) return i === t;
      ...
      t({
        ...
        s("click", (t, s) => {
          const { $nextEl: n, $prevEl: r } = e.navigation,
            o = s.target;
          if (e.params.navigation.hideOnClick && !_(o).is(r) && !_(o).is(n)) {
            if (
              e.pagination &&
              e.params.pagination &&
    ...
    function me({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function d() {
        ...
        if (
          ("fraction" === s.type &&
            (d.find(ge(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            d.find(ge(s.totalClass)).text(s.formatFractionTotal(u))),
          "progressbar" === s.type)
        ) {
          let t;
      ...
      ye(),
        document.querySelector(".masters__slider") &&
          new ue(".masters__slider", {
            ...
            navigation: { nextEl: ".arrows__next", prevEl: ".arrows__prev" },
            breakpoints: {
        ...
        document.querySelector(".page-feedback__slider") &&
          new ue(".page-feedback__slider", {
            modules: [he, me, ve],
            effect: "fade",
            ...
            speed: 800,
            pagination: {
              el: ".page-feedback__arrows-number",
              clickable: !0,
              type: "fraction",
            },
            navigation: {
              nextEl: ".page-feedback__arrows-next",
              prevEl: ".page-feedback__arrows-prev",
            },
            on: {},
          }),
    ...
    var Te = function (e, t, s, i) {
        void 0 === s && (s = 0);
        var n = Se(e).attr("data-lg-size") || i;
        if (n) {
          var r = n.split(",");
          if (r[1])
      ...
      Ie = function (e, t, s, i, n) {
        if (n) {
          var r = Se(e).find("img").first();
          if (r.get()) {
      ...
      De = "lgAfterAppendSlide",
      Be = "lgInit",
      Ge = "lgHasVideo",
      Ne = "lgContainerResize",
      He = "lgUpdateSlides",
        ...
        return (
            ...
            if (!(this.$container && this.$container.get())) {
              ...
              var n = this.settings.ariaLabelledby
                ...
                d =
                  ...
                  "\n                </div>\n            </div>\n        </div>\n        ";
              Se(this.settings.container).css("position", "relative").append(d),
          ...
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (r = Ie(t, this.outer, a, l, this.currentImageSize))),
          ...
          (e.prototype.addHtml = function (e) {
            ...
            if (".lg-item" !== this.settings.appendSubHtmlTo)
              ...
              var n = Se(this.getSlideItemId(e));
              s
                ? n.load(s)
          ...
          (e.prototype.getDummyImageContent = function (e, t, s) {
            var i;
            if ((this.settings.dynamic || (i = Se(this.items).eq(t)), i)) {
              var n = void 0;
              if (
          ...
          (e.prototype.addSlideVideoInfo = function (e) {
            ...
            e.forEach(function (e, s) {
              (e.__slideVideoInfo = $e(e.src, !!e.video, s)),
                e.__slideVideoInfo &&
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            var T = 0;
            v && !Se(document.body).hasClass("lg-from-hash") && (T = v),
              this.isFirstSlideWithZoomAnimation() &&
                (setTimeout(function () {
                  n.removeClass(
            ...
            "lg-slide" !== this.settings.mode &&
              ...
              setTimeout(function () {
                ...
                if (
                  ...
                  var a = Se(s.target);
                  n.isPosterElement(a) && n.LGel.trigger(Ye);
                }
          ...
          (e.prototype.enableDrag = function () {
            ...
            this.settings.enableDrag &&
              ...
              Se(window).on("mousemove.lg.global" + this.lgId, function (r) {
                i &&
                  e.lgOpened &&
                  ((n = !0),
              ...
              Se(window).on("mouseup.lg.global" + this.lgId, function (r) {
                if (e.lgOpened) {
                  var o = Se(r.target);
                  n
                    ? ((n = !1), e.touchEnd(s, t, r), e.LGel.trigger(Ke))
                    : e.isPosterElement(o) && e.LGel.trigger(Ye),
                    i &&
                      ((i = !1),
    ...
    let at = document.getElementsByClassName("footer__item"),
    ...
    !(function () {
      ...
      (function () {
        ...
        function l(e) {
          ...
          } else "resize" === d && (t.length && o(t), s.length && i(s));
        }
        e.length &&
